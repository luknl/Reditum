...
class Card3 extends Component {
  ...
  replaceAt(route) {
    this.props.replaceAt('card3', { key: route }, this.props.navigation.key);
  }
  ...
  //     image: 'http://www.tourisme93.com/visites/1041-1847-thickbox_default/les-studios-mythiques-pathe-al.jpg',
  //     card: 'card3',
  //   }])
  // }
      ...
      <Container theme={myTheme} style={styles.container}>
        ...
        <Content padder style={styles.padder}>
          ...
          <WebView style={styles.webview}
            ...
            source={{uri: 'http://www.lucaphotos.com/reditum/pagethree.html'}}
          />
        </Content>
...
export default connect(mapStateToProps, bindAction)(Card3);
