...
export default {
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: (Platform.OS === 'ios') ? '#F8F8F8' : '#FEFEFE',

  // FooterTab
  tabBarTextColor: (Platform.OS === 'ios') ? '#6b6b6b' : '#b3c7f9',
  tabBarActiveTextColor: (Platform.OS === 'ios') ? '#007aff' : '#E2C494',
  tabActiveBgColor: (Platform.OS === 'ios') ? '#e4f0fe' : undefined,

  // Header
  iosToolbarBtnColor: '#E2C494',
  toolbarDefaultBg: (Platform.OS === 'ios') ? '#F8F8F8' : '#FEFEFE',
  toolbarHeight: (Platform.OS === 'ios') ? 64 : 56,
  toolbarIconSize: (Platform.OS === 'ios') ? 20 : 22,
  toolbarInputColor: '#CECDD2',
  toolbarInverseBg: '#222',
  toolbarTextColor: (Platform.OS === 'ios') ? '#000' : '#E2C494',
  get statusBarColor() {
